...
Channel Surf is a command line tool that helps you succeed with Microsoft Teams.  Moving from Slack or starting fresh?  Here's what Channel Surf enables you to do:
